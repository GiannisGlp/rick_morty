class CharactersModel {
  ...
  CharactersModel.withError(String errorMessage) {
    error = errorMessage;
  }
...
class Results {
  ...
  Results.fromJson(Map<String, dynamic> json) {
    ...
    firstEpisode = json['firstEpisode'] != null
        ? new FirstEpisode.fromJson(json['firstEpisode'])
        : null;
    location =
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.firstEpisode != null) {
      data['firstEpisode'] = this.firstEpisode!.toJson();
    }
...
class FirstEpisode {
  ...
  FirstEpisode.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
